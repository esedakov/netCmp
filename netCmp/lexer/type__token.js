...
var TOKEN_TYPE = {
	...
	IN: {value:29, name:"cmd_In", matcher:"in"},
	...
	MULTIPLY: {value:42, name:"op_Mod", matcher:"mod"},
	//syntax
	ARRAYOPEN: {value:43, name:"sy_ArrOpen", matcher:"["},
	ARRAYCLOSE: {value:44, name:"sy_ArrClose", matcher:"]"},
	PARANOPEN: {value:45, name:"sy_ParanOpen", matcher:"("},
	PARANCLOSE: {value:46, name:"sy_ParanClose", matcher:")"},
	CODEOPEN: {value:47, name:"sy_CodeOpen", matcher:"{"},
	CODECLOSE: {value:48, name:"sy_CodeClose", matcher:"}"},
