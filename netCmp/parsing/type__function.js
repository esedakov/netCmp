...
var FUNCTION_TYPE = {
	...
	//cast methods
	INT_TO_TXT: {value: 61, name: "int2txt"},	//ES 2016-09-21 (b_libs_1): cast: int to text
	INT_TO_REAL: {value: 62, name: "int2real"},//ES 2016-09-21 (b_libs_1): cast: int to real
	INT_TO_BOOL: {value: 63, name: "int2bool"},//ES 2016-09-21 (b_libs_1): cast: int to boolean
	TXT_TO_INT: {value: 64, name: "txt2int"},	//ES 2016-09-21 (b_libs_1): cast: text to int
	TXT_TO_REAL: {value: 65, name: "txt2real"},//ES 2016-09-21 (b_libs_1): cast: text to real
	TXT_TO_BOOL: {value: 66, name: "txt2bool"},//ES 2016-09-21 (b_libs_1): cast: text to boolean
	REAL_TO_INT: {value: 67, name: "real2int"},//ES 2016-09-21 (b_libs_1): cast: real to int
	REAL_TO_TXT: {value: 68, name: "real2txt"},//ES 2016-09-21 (b_libs_1): cast: real to text
	REAL_TO_BOOL: {value: 69, name: "real2bool"},//ES 2016-09-21 (b_libs_1): cast: real to boolean
	BOOL_TO_INT: {value: 70, name: "bool2int"},//ES 2016-09-21 (b_libs_1): cast: boolean to int
	BOOL_TO_TXT: {value: 71, name: "bool2txt"},//ES 2016-09-21 (b_libs_1): cast: boolean to text
	BOOL_TO_REAL: {value: 72, name: "bool2real"},//ES 2016-09-21 (b_libs_1): cast: boolean to real
	TXT_TO_DT: {value: 73, name: "txt2datetime"},	//ES 2016-09-21 (b_libs_1): cast: text to date-time
	DT_TO_TXT: {value: 74, name: "datetime2txt"},	//ES 2016-09-21 (b_libs_1): cast: date-time to text
	//point
