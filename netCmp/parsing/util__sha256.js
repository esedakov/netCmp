...
//ES 2015-10-03 (HOW TO USE): Sha256.hash(####);
//ES 2015-10-03 (URL WHERE FOUND): http://www.movable-type.co.uk/scripts/sha256.html
...
Sha256.hash = function(msg) {
    ...
    for (var i=0; i<N; i++) {
        ...
        for (var t=16; t<64; t++) W[t] = (Sha256.Sum1(W[t-2]) + W[t-7] + Sha256.Sum0(W[t-15]) + W[t-16]) & 0xffffffff;
